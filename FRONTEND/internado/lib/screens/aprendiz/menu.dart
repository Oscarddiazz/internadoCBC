...
class MenuAprendiz extends StatefulWidget {
  const MenuAprendiz({super.key});

  @override
  State<MenuAprendiz> createState() => _MenuAprendizState();
}

class _MenuAprendizState extends State<MenuAprendiz> {
        ...
        onTap: (index) {
          ...
          switch (index) {
            case 0: // Home
              ...
              break;
            case 1: // Perfil
              Navigator.pushNamed(context, AppRoutes.perfilAprendizScreen);
              break;
            case 2: // Configuración
              Navigator.pushNamed(
                context,
                AppRoutes.configuracionAprendizScreen,
              );
              break;
          }
        },
