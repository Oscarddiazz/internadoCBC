...
class DelegadoProfilePage extends StatefulWidget {
  const DelegadoProfilePage({super.key});

  @override
  State<DelegadoProfilePage> createState() => _DelegadoProfilePageState();
}

class _DelegadoProfilePageState extends State<DelegadoProfilePage> {
