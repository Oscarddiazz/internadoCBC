...
class DelegadoNotificationsPage extends StatefulWidget {
  const DelegadoNotificationsPage({super.key});

  @override
  State<DelegadoNotificationsPage> createState() =>
      _DelegadoNotificationsPageState();
}

class _DelegadoNotificationsPageState extends State<DelegadoNotificationsPage> {
